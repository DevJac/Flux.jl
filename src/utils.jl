...
kaiming_uniform(rng::AbstractRNG; kwargs...) = (dims...; kwargs_λ...) -> kaiming_uniform(rng, dims...; merge(kwargs, kwargs_λ)...)
...
kaiming_normal(rng::AbstractRNG; kwargs...) = (dims...; kwargs_λ...) -> kaiming_normal(rng, dims...; merge(kwargs, kwargs_λ)...)
...
sparse_init(rng::AbstractRNG; kwargs...) = (dims...; kwargs_λ...) -> sparse_init(rng, dims...; merge(kwargs, kwargs_λ)...)
